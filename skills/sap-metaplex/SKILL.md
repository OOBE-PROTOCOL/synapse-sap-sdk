...
name: sap-metaplex
description: |
  Metaplex Core bridge for SAP SDK v1.0.0.
...
# SAP × Metaplex Core — Bridge Skill Guide (v1.0.0)

> **Module**: `client.metaplex` (MetaplexBridge)  
> **SAP SDK**: `@oobe-protocol-labs/synapse-sap-sdk@1.0.0`  
...
6. **Version drift** — This bridge guide targets SDK v1.0.0. If using a
