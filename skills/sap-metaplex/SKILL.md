...
name: sap-metaplex
description: |
  Metaplex Core bridge for SAP SDK v0.3.0.
...
# SAP × Metaplex Core — Bridge Skill Guide (v0.3.0)

> **Module**: `client.metaplex` (MetaplexBridge)  
> **SAP SDK**: `@oobe-protocol-labs/synapse-sap-sdk@0.3.0`  
...
6. **Version drift** — This bridge guide targets SDK v0.3.0. If using a
